        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Diet = table.Column<string>(type: "character varying(80)", maxLength: 80, nullable: false),
                    Intolerances = table.Column<List<string>>(type: "text[]", nullable: false),
                    CuisineTypes = table.Column<List<string>>(type: "text[]", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Users_Preferences_UserPreferencesId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SpoonacularRecipeId = table.Column<long>(type: "bigint", nullable: false),
